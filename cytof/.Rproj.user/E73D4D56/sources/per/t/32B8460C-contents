...
pipe = function(timepoint, in.group, datatype, pval) {
  ...
  write.csv(res[res$p.val < 0.05,], paste('ttest/combat_correct/', timepoint, pval, '_', in.group, '_', datatype, '.csv', sep = ''))
  
  
  library(EnhancedVolcano)
  jpeg(paste('ttest/combat_correct/', datatype, '/', timepoint, pval, '_', in.group, '_', datatype, '_ctrl_corrected.jpeg', sep = ''),
