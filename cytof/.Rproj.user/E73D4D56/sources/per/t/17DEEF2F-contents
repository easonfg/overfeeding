...
for (time in list(list(1,2), list(1,3), list(1,4), list(2,3), list(2,4), list(3,4))){
  time1 = time[[1]]
  time2 = time[[2]]
  assign(paste0('tp', time1, '_', time2), read.csv(paste0('zoe/', time1, '_', time2, 
...
str(all.timepoints)
# all.timepoints = all.timepoints[all.timepoints$timepoint == 'tp1_2',]
# all.timepoints = all.timepoints[all.timepoints$timepoint == 'tp1_3',]
all.timepoints = all.timepoints[all.timepoints$timepoint == 'tp1_4',]

# pdf('logistic2_more_ctrl_batchCorrectinLM/dotplots.res.1.2.pdf',
# pdf('zoe/dotplots.res.1.2.pdf',
# pdf('zoe/dotplots.res.1.3.pdf',
pdf('zoe/dotplots.res.1.4.pdf',
    width=8, height=8)
    # width=20, height=8)
###plot all timepoints
print(
