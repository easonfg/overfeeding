...
pipe = function(timepoint, in.group, datatype, pval) {
  ...
  write.csv(res[res$timepoint.p.val.P < 0.05,], paste('logistic2_controlled_batchCorrectinLM/', timepoint, pval, '_', in.group, '_', datatype, '_controlled_BatchCinLM.csv', sep = ''))
